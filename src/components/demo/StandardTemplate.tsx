...
const StandardTemplate = ({ data, theme, name, specialtyLabel, city, phone, location }: StandardTemplateProps) => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-slate-900" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            {/* Stats Section */}
            <section style={{ background: theme.gradient }} className="py-16 text-white">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-6 mt-8">
                                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                                    <div className="text-3xl font-bold mb-1" style={{ fontFamily: "'Playfair Display', serif", color: theme.accent }}>MBBS, MD</div>
                                    <div className="text-xs font-bold text-slate-400 uppercase tracking-wider">Qualification</div>
                                </div>
                                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                                    <div className="text-3xl font-bold mb-1" style={{ fontFamily: "'Playfair Display', serif", color: theme.accent }}>10k+</div>
